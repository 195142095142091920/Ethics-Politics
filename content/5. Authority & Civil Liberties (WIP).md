...
#### Position 
Property rights rank among the strongest negative rights. Once ownership is legitimately acquired, it is permanent and may be defended with proportionate force. Eminent domain is limited to narrow public-use cases with full compensation. Ordinary zoning is not treated as a taking, though rules that strip property of its real value without payment cross the line. Intellectual property is protected for practical reasons even though its foundations are thinner than physical property. As population grows and time passes, adjustment occurs through voluntary exchange, development, and new value creation rather than political resetting of titles.
...
- Baseline zoning is allowed; regulation that destroys the practical value of ownership without compensation is treated as a taking.
- Intellectual property receives protection for practical reasons, subject to reasonable limits.
- Proportionate force, including lethal force when necessary, may be used to stop violent intrusion or significant loss that cannot be prevented by lesser means.
- Population growth and the passage of time are handled through markets, intensification, and new forms of value, not through periodic redistribution of existing titles.
...
Zoning sits in the middle. Some basic coordination rules can reduce conflict without destroying ownership. When regulation becomes so heavy that formal title remains while the real value of the property is hollowed out, it functions as a taking and should require compensation.
...
Defense of property follows ordinary proportionality. An owner may use the force needed to stop the violation. Lethal force is proportionate when the intrusion is violent or when, under the actual circumstances, lesser means cannot reliably prevent significant loss and the situation carries risk to people or to the security of the home. Once the immediate threat ends, the response shifts to restitution and scaled criminal penalties.
